...
public class AllBlocks {
    ...
    public static final RegistryObject<Block> ACCELERATOR_LAY  = BLOCKS.register("accelerator_lay", () -> new AcceleratorBlock(getProperties().noOcclusion()));
...
//    public static final RegistryObject<Block> ELECTRIC_WIRE = BLOCKS.register("electric_wire", () -> new ElectricWireBlock(getProperties())); // TODO:报错太多暂时删掉
    ...
    public static final RegistryObject<Block> COPPER_PRESSURE_PLATE = BLOCKS.register("copper_pressure_plate", () -> new CopperPressurePlateBlock(getProperties().strength(0.5F).noCollission()));
    public static final RegistryObject<Block> TITANIUM_PRESSURE_PLATE = BLOCKS.register("titanium_pressure_plate", () -> new TitaniumPressurePlateBlock(getProperties().strength(0.5F).noCollission()));
    public static final RegistryObject<Block> STEEL_PRESSURE_PLATE = BLOCKS.register("steel_pressure_plate", () -> new SteelPressurePlateBlock(getProperties().strength(0.5F).noCollission()));
    ...
    public static final RegistryObject<Block> TITANIUM_ALLOY_PRESSURE_PLATE = BLOCKS.register("titanium_alloy_pressure_plate", () -> new TitaniumAlloyPressurePlateBlock(getProperties().noCollission()));
    public static final RegistryObject<Block> TUNGSTEN_PRESSURE_PLATE = BLOCKS.register("tungsten_pressure_plate", () -> new TungstenPressurePlateBlock(getProperties().strength(0.5F).noCollission()));
